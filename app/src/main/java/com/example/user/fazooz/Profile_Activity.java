...
public class Profile_Activity extends AppCompatActivity {
    ...
    private void email() {
        ...
        ImageButton addressb=(ImageButton)findViewById(R.id.mail_edit);
        final TextView temail=(TextView)findViewById(R.id.mail);
    ...
    private void addressclicker() {
        ...
        ImageButton username=(ImageButton)findViewById(R.id.address_edit);
        final TextView taddress=(TextView)findViewById(R.id.address);
    ...
    private void phonenumberclicker() {
        ImageButton ph_no=(ImageButton)findViewById(R.id.edit_ph);
        final TextView tphonenumber=(TextView)findViewById(R.id.ph_num1);
    ...
    private void usernameclicker() {
        ...
        final ImageButton usernameq=(ImageButton)findViewById(R.id.imageButton3);
        final TextView tusername=(TextView)findViewById(R.id.ans_name);
...
//                );
    ...
    private void setnames() {
        ...
        TextView name1=(TextView)findViewById(R.id.ans_usr_name);
        name1.setText(username);
        TextView username1=(TextView)findViewById(R.id.ans_name);
        username1.setText(name);
        TextView mobile1=(TextView)findViewById(R.id.ph_num1);
        mobile1.setText(mobile);
        TextView address1=(TextView)findViewById(R.id.address);
        address1.setText(address);
        TextView email1=(TextView)findViewById(R.id.mail);
...
//
//
//        button = (ImageButton) findViewById(R.id.camera_btn);
//        imageView = (ImageView) findViewById(R.id.yug);
