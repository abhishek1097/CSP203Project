...
public class BlankFragment extends Fragment {
    ...
    String fusername,fphone_number,faddress,femail,fname;
    ...
    public static BlankFragment newInstance(String param1,String param2,String param3,String param4,String param5,String param6,String param7) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        photoset(view);
        clickers(view);
        onButtonPressed(mParam1,mParam2,mParam3,mParam4,mParam5,mParam6,mParam7);
...
//start the activity - we handle returning in onActivityResult
    ...
    public void onButtonPressed(String name,String username,String mobile,String address,String email,String category,String restraunt) {
        if (mListener != null) {
            String fname,fusername,fmobile,faddress,femail,fcategory,frestraunt;
...
//                username=susername;
//            }
            mListener.onFragmentInteraction(name,username,mobile,saddress,email,category,restraunt,0);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onFragmentInteraction(String name,String username,String email,String mobile,String category,String address,String restraunt,int i);
    }
}
